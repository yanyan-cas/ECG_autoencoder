...
%% ======================================================================
%  Load MIT data
load RESULT/opt221.mat
clear netconfig pred testlabels stackedAEOptTheta
divcon;
%% ======================================================================
...
sae3OptTheta = initializeParameters(hiddenSizeL3, hiddenSizeL2); %  Randomly initialize the parameters
for i = 1 : 6
    ...
    if batch_data_size > 200000
        ...
        [sae3OptTheta] = batch_trainAE( sae1OptTheta,sae2OptTheta,sae3OptTheta ,batch_data );
    end
end     
