...
y_h4 = sigmoid(stack{4}.w * y_h3 + repmat(stack{4}.b,1,dataSize));
...
softmaxThetaGrad = -dataMean * (groundTruth - P) * y_h4' + lambda  * softmaxTheta;
cigma5 = -softmaxTheta' * (groundTruth - P) .* y_h4 .* (1 - y_h4);
cigma4 = stack{4}.w' * cigma5 .* y_h3 .* (1 - y_h3);
cigma3 = stack{3}.w' * cigma4 .* y_h2 .* (1 - y_h2);
cigma2 = stack{2}.w' * cigma3 .* y_h1 .* (1 - y_h1);
stackgrad{4}.w = dataMean * (cigma5 * y_h3');
stackgrad{4}.b = mean(cigma5,2);
